...
# Same as stopsign.py but using the basic ideas of concepts rather than using matplotlib to do the video

# Show the video using the pygame method rather than using pyplot which is much slower
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        while True:
            ...
            screen.blit(pygame.image.frombuffer(image_np.tostring(), image_np.shape[1::-1], "RGB"), (0, 0))
            pygame.display.flip()
